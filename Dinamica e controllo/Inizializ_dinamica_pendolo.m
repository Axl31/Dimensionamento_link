...
function [JL,JM,Inerzia_link,Inerzia_motori,masse_link,masse_motori,Q,Q_dot,g0]= Inizializ_dinamica_pendolo(link)
...
COM_1=[(0.08572*100)-l1; 0; 0];     %Terna1 [cm]
COM_2=[(0.0115*100)-l2; 0; 0];      %Terna2
COM_3=[(0.0115*100)-l3; 0; 0];     %Terna3
COM_4=[(0.003*100)-l4; 0; 0];
